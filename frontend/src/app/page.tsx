...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-purple-50 to-teal-50 p-4 relative overflow-hidden">
      ...
      <div className="absolute top-20 left-10 w-32 h-32 rounded-full bg-blue-200/30 blur-xl"></div>
      <div className="absolute bottom-20 right-10 w-40 h-40 rounded-full bg-purple-200/30 blur-xl"></div>
      <div className="absolute top-1/3 right-1/4 w-24 h-24 rounded-full bg-teal-200/30 blur-xl"></div>

      <div className="w-full max-w-2xl z-10">
        <div className="text-center mb-10">
          <div className="mx-auto w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center shadow-lg mb-6">
        ...
        <div className="bg-white/70 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/30 p-8 md:p-12">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600">Join thousands of users who organize their tasks efficiently</p>
          </div>
          ...
          <div className="space-y-5">
            <div>
              <Link href="/login">
                <button
                  type="button"
                  className="w-full flex justify-center py-4 px-6 border border-transparent rounded-xl shadow-lg text-base font-medium text-white bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 focus:outline-none focus:ring-4 focus:ring-blue-300/50 transition-all duration-300 transform hover:scale-[1.02]"
                >
            ...
            <div className="pt-4">
              <Link href="/signup">
                <button
                  type="button"
                  className="w-full flex justify-center py-4 px-6 border border-gray-300 rounded-xl shadow-lg text-base font-medium text-gray-800 bg-gradient-to-r from-white to-gray-100 hover:from-gray-50 hover:to-gray-200 focus:outline-none focus:ring-4 focus:ring-gray-300/50 transition-all duration-300 transform hover:scale-[1.02]"
                >
                  Create new account
                </button>
              </Link>
